    ...
    return `
      <div
          ...
          <div style="margin:0 auto;max-width:600px;padding:24px;background: #fff;">
              ...
              <p>
                  <a href="${url}" target="_blank"style="text-decoration: none;background-color: #1f8feb;color: white;padding: 12px 24px;border-radius: 4px;margin: 20px 0;">VVTStore</a>
              </p>
              <p>- The VVTStore Team <img style="margin:0 0.2ex;vertical-align:middle;max-height:24px" alt="🖖" src="https://mail.google.com/mail/e/1f596"></p>
          </div>
          <div style="clear: both;text-align: center;padding:20px">
              <span style="color:#95a1ac;font-size:12px;">© Bản quyền thuộc về VVTStore</span>
          </div>
      </div>
      `;
};
